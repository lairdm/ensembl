...
$multi->hide('patch', 'gene_expression', 'transcript_expression', 'exon_expression', 'tissue');
...
my $gene = $ga->fetch_by_stable_id('ENSG00000112769');
...
is($count, 1, "Stored a gene expression for ENSG00000112769");
...
is(@expressions, 1, "Fetched one expression for ENSG00000112769");

@expressions = @{$ea->fetch_all_by_Gene($gene, "rubbish")};
is(@expressions, 0, "Fetched no expression for ENSG00000112769 and tissue rubbish");

@expressions = @{$ea->fetch_all_by_Gene($gene, "test_name2")};
is(@expressions, 1, "Fetched one expression for ENSG00000112769 and tissue test_name2");

@expressions = @{$ea->fetch_all_by_Gene($gene, undef, "rubbish")};
is(@expressions, 0, "Fetched no expression for ENSG00000112769 and analysis rubbish");

@expressions = @{$ea->fetch_all_by_Gene($gene, undef, "test_ana2")};
is(@expressions, 1, "Fetched one expression for ENSG00000112769 and analysis test_ana2");

@expressions = @{$ea->fetch_all_by_Gene($gene, undef, undef, "RPKM")};
is(@expressions, 0, "Fetched no expression for ENSG00000112769 and value type RPKM");

@expressions = @{$ea->fetch_all_by_Gene($gene, undef, undef, "count")};
is(@expressions, 1, "Fetched one expression for ENSG00000112769 and value type count");
...
is($count, 1, "One entry in gene_expression table for gene ENSG00000112769");
...
is($count, 0, "No entry in gene_expression table for gene ENSG00000112769 and tissue test_name2");
...
is(@expressions, 0, "No expressions any more for ENSG00000112769");
...
is($count, 1, "Found one entry in gene_expression for ENSG00000112769");
...
@expressions = @{$ea->fetch_all_by_Gene($gene)};
is(@expressions, 1, "One expression for ENSG00000112769");
...
my $exon = $exa->fetch_by_stable_id('ENSE00001835671');
...
is($count, 1, "Stored a exon expression for ENSE00001835671");

#
# test that we can now retrieve this expression
#
my @expressions = @{$ea->fetch_all_by_Exon($exon)};
is(@expressions, 1, "Fetched one expression for ENSE00001835671");
...
is($count, 0, "No entry in exon_expression table for exon ENSE00001835671 and tissue test_name2");




$multi->restore('patch', 'gene_expression', 'transcript_expression', 'exon_expression', 'tissue');
